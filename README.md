...
0. You should have downloaded the folder dataset_clean and added it in the main folder, You should download the file `weights_results/results_unsupervised/new_results_wnet_1500e.zip` from the Drive and extract it into a folder that you should create `weights_results/results_unsupervised/new_results_wnet_1500e`
